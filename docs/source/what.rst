...
An asynchronous sanic_ webapp running inside a `python docker image`_ using uvloop_ as the event loop.
...
If you're using the `Switcher water heater`_ and you want to wrap a rest api around it...
